        ...
        switch (purposeId) {
            case 1:
                serializedLayers2k.push({
                    "baseURL": "http://geoserver.sig.cm-agueda.pt:8080/geoserver/wms",
            ...
            case 2:
                ...
                legendClass.push({
                    "icons": ["http://geoserver.sig.cm-agueda.pt:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=ran_etrs89&FORMAT=image%2Fpng&SCALE=2183915&LEGEND_OPTIONS=dpi:254"],
                    "name": "Reserva Agrícola Nacional"
                });
                /*
                 legendClass.push({
                 "icons": ["http://geoserver.sig.cm-agueda.pt:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=carto10k&FORMAT=image%2Fpng"],
                 "name": "Cartografia 10k"
                 });
                 legendClass.push({
                 "icons": ["http://geoserver.sig.cm-agueda.pt:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=carto2_5k&FORMAT=image%2Fpng"],
            ...
            case 3:
                ...
                legendClass.push({
                    "icons": ["http://geoserver.sig.cm-agueda.pt:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=ren_etrs89&FORMAT=image%2Fpng&SCALE=2183915&LEGEND_OPTIONS=dpi:254"],
