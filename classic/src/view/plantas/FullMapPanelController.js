Ext.define('Admin.view.plantas.FullMapPanelController', {
    ...
    onPrintPlanta: function (printid, pretensaoid, name) {
        ...
        switch (purposeId) {
            ...
            case 2:
                ...
                legendClass.push({
                    "icons": ["http://localhost:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=ran_etrs89&FORMAT=image%2Fpng&SCALE=2183915&LEGEND_OPTIONS=dpi:254"],
                    "name": "Reserva Agrícola Nacional"
                });
                /*
                 legendClass.push({
                 "icons": ["http://localhost:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=carto10k&FORMAT=image%2Fpng"],
                 "name": "Cartografia 10k"
                 });
                 legendClass.push({
                 "icons": ["http://localhost:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=carto2_5k&FORMAT=image%2Fpng"],
            ...
            case 3:
                ...
                legendClass.push({
                    "icons": ["http://localhost:8080/geoserver/wms?request=GetLegendGraphic&format=image%2Fpng&width=20&height=20&layer=ren_etrs89&FORMAT=image%2Fpng&SCALE=2183915&LEGEND_OPTIONS=dpi:254"],
    ...
    downloadWhenReady: function (me, startTime, data) {
        if ((new Date().getTime() - startTime) > 50000) {
            ...
            setTimeout(function () {
                Ext.Ajax.request({
                    // http://localhost/print/print/status/25b98152-4851-40ee-9815-d8165618356d@52c79669-f75a-4a72-994c-be63fc547666.json?_dc=1478194584027
